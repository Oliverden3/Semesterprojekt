...
public class UserMapper implements IUserMapper {
    ...
    @Override
    public User login(String username, String password, int balance) throws DatabaseException {
        Logger.getLogger("web").log(Level.INFO, "");

        User user = null;

        String sql = "SELECT * FROM user WHERE username = ? AND password = ? AND balance = ?";
    ...
    @Override
    public User createUser(String username, String password, int balance, String role) throws DatabaseException {
        Logger.getLogger("web").log(Level.INFO, "");
        User user;
